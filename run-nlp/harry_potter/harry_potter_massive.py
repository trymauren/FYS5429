...
seq_length = 24
num_sequences = 5000
savepath = path_to_root + f'/run-nlp/harry_potter/saved_models/massive/massive'
train = True
infer = False


def train_rnn(savepath=None, X=None, y=None, vocab=None):
...
if __name__ == "__main__":
    ...
    if train:
        train_rnn(savepath=savepath, X=X, y=y, vocab=vocab)
    ...
    if infer:
        ...
        plt.legend()
        plt.savefig(path_to_root + f'/run-nlp/harry_potter/saved_figs/massive_{seq_length}_loss.svg')
